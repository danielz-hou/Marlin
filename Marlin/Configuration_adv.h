 ...
 */
  ...
  #define PROBING_MARGIN_RIGHT (X_BED_SIZE + X_PROBE_OFFSET - (-33))) 
  #define PROBING_MARGIN_FRONT (MIN_PROBE_EDGE)
  #define PROBING_MARGIN_BACK (Y_BED_SIZE + Y_PROBE_OFFSET - (2))
#endif
