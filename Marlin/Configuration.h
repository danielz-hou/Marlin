 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {-33 , 2, 0 }
 ...
 * probe Z set with NOZZLE_TO_PROBE_OFFSET, M851, or the LCD.
 ...
 * These options are most useful for the probe, but may also improve
...
#define Y_MIN_POS -17
#define Z_MIN_POS 0
#define X_MAX_POS (X_BED_SIZE+36)
